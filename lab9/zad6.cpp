...
//
//Дизајнирате програма за каталог на музички инструменти. За ова ќе треба да креирате базична класа наречена MusicalInstrument што претставува генерички музички инструмент и ги има овие три чисти виртуелни функции:
...
//За displaySoundQuality() треба да печати The sound quality of this string instrument is rated [quality] out of 10. каде што квалитетот се пресметува врз основа на тоа дали инструментот е електричен или не. Ако е електричен, оценката е 9 од 10, а ако не е, оценката е 7 од 10.
