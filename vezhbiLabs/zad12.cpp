...
private:
    ...
    int duration;
public:
    Speaker(string name="", string title="", int duration=0){
        this->name=name;
        this->title=title;
    ...
    friend ostream&operator<<(ostream &os, const Speaker &out){
        os<<out.name<<" - "<<out.title<<", "<<out.duration<<endl;
    }
};
class Conference{
private:
